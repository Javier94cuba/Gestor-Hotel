...
export default async function ADD_envio() {
  ...
  return (
    <>
    <form>
      <div className=" text-center bg-gray-700 pt-10">
        <div className="border-b border-white/10">
          <p className="mt-1 text-xl leading-6 text-white">
            Esta información es crucial para añadir a la base de datos de productos
          </p>

          <div className="mt-10 grid grid-cols-1 gap-x-6 gap-y-8 sm:grid-cols-6">
            <div className="sm:col-span-4 flex space-x-4">
              <label htmlFor="username" className="text-sm font-medium text-white pt-2 ml-12">
                Nombre :
              </label>
              <div className="">
                <div className="flex rounded-md bg-white/5 ring-1 ring-inset ring-white/10 focus-within:ring-2 focus-within:ring-inset focus-within:ring-indigo-500">
                  <span className="flex select-none items-center pl-3 text-gray-300 sm:text-sm"></span>
                  <input
                    type="text"
                    name="username"
                    id="username"
            ...
            <div className="sm:col-span-4 flex space-x-4">
              <label htmlFor="username" className="text-sm font-medium text-white pt-2 ml-10">
                 Cantidad :
              </label>
              <div className="">
                <div className="flex rounded-md bg-white/5 ring-1 ring-inset ring-white/10 focus-within:ring-2 focus-within:ring-inset focus-within:ring-indigo-500">
            ...
            <div className="sm:col-span-4 flex space-x-4">
              <label htmlFor="username" className="text-sm font-medium text-white pt-2 ml-8">
                Proveedor :
              </label>
              <div className="">
                <div className="flex rounded-md bg-white/5 ring-1 ring-inset ring-white/10 focus-within:ring-2 focus-within:ring-inset focus-within:ring-indigo-500">
            ...
            <div className="ml-10 sm:col-span-3 flex items-center space-x-2 pb-20">
