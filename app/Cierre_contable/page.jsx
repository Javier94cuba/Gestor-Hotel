...
function Cierre_contable() {
  ...
  return (
    ...
    <div name="Desglose de billetes" className="px-4 sm:px-6 lg:px-8 mt-6">
      ...
      <div className="-mx-4 mt-8 flow-root sm:mx-0">
        <table className="min-w-full">
          ...
          <thead className="border-b border-gray-300 text-gray-900">
            <tr>
              <th scope="col" className="py-3.5 pl-4 pr-3 text-left text-lg font-semibold text-red-500 sm:pl-0">
