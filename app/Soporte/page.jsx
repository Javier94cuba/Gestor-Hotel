...
const pricing = {
  ...
  tiers: [
    ...
    },
    {
      ...
      href: '#',
      featured: true,
      description: 'Servicios financieros y contables para tu Tienda',
      price: { monthly: '1.5%', annually: '1.1%' },
      mainFeatures: [
        'Vistas en Tablets, Movil, Laptop',
        'Requiere internet',
        'Multi cuentas',
        'Para varias monedas',
        'Ipv, Almacen...',
...
const faqs = [
  {
    id: 1,
    question: "Como puedo pagar esta app, en otra moneda",
    answer:
      "Via transfermovil aceptamos cualquier moneda MN, MLC",
  },
  // More questions...
]
  ...
  return (
    <div className="bg-white">
      ...
      <main>
            ...
            <div className="mx-auto max-w-7xl px-6 lg:px-8">
              <div className="relative z-10">
                <h1 className="mx-auto max-w-4xl text-center text-5xl font-bold tracking-tight text-white">
                   Gestor presupuesto mensual - anual
                </h1>
                <p className="mx-auto mt-4 max-w-2xl text-center text-lg leading-8 text-white/60">
                  Gestor es la respuesta para tu gestión económica, siga leyendo las facilidades que brinda nuestra app personalizada
                </p>
                <p className="mx-auto mt-4 max-w-2xl text-center text-lg leading-8 text-white/60">
                  Contactar - 58386901 - jlopezhdez94@gmail.com
                </p>
        ...
        {/* FAQ section */}
        <div className="mx-auto max-w-7xl divide-y divide-gray-900/10 sm:mt-0 lg:px-8 mb-20">
